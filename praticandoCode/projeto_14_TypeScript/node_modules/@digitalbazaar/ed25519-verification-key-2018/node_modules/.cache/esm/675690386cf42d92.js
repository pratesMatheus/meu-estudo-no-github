let sign,verify,createPrivateKey,createPublicKey,randomBytes,promisify;_6cf‍.x([["default",()=>_6cf‍.o],["_privateKeyDerEncode",()=>_privateKeyDerEncode],["_publicKeyDerEncode",()=>_publicKeyDerEncode]]);_6cf‍.w("crypto",[["sign",["sign"],function(v){sign=v}],["verify",["verify"],function(v){verify=v}],["createPrivateKey",["createPrivateKey"],function(v){createPrivateKey=v}],["createPublicKey",["createPublicKey"],function(v){createPublicKey=v}],["randomBytes",["randomBytes"],function(v){randomBytes=v}]]);_6cf‍.w("util",[["promisify",["promisify"],function(v){promisify=v}]]);/*!
