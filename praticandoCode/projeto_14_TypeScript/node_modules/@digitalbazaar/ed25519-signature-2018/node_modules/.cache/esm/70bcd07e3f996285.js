let base58btc,jsonld,JwsLinkedDataSignature,Ed25519VerificationKey2018,Ed25519VerificationKey2020,ed25519Signature2018SuiteContext,ed25519Signature2020SuiteContext;_3f9‍.x([["Ed25519Signature2018",()=>Ed25519Signature2018]]);_3f9‍.w("base58-universal",[["*",null,function(v){base58btc=v}]]);_3f9‍.w("jsonld",[["default",["jsonld"],function(v){jsonld=v}]]);_3f9‍.w("@digitalbazaar/jws-linked-data-signature",[["JwsLinkedDataSignature",["JwsLinkedDataSignature"],function(v){JwsLinkedDataSignature=v}]]);_3f9‍.w("@digitalbazaar/ed25519-verification-key-2018",[["Ed25519VerificationKey2018",["Ed25519VerificationKey2018"],function(v){Ed25519VerificationKey2018=v}]]);_3f9‍.w("@digitalbazaar/ed25519-verification-key-2020",[["Ed25519VerificationKey2020",["Ed25519VerificationKey2020"],function(v){Ed25519VerificationKey2020=v}]]);_3f9‍.w("ed25519-signature-2018-context",[["default",["ed25519Signature2018SuiteContext"],function(v){ed25519Signature2018SuiteContext=v}]]);_3f9‍.w("ed25519-signature-2020-context",[["default",["ed25519Signature2020SuiteContext"],function(v){ed25519Signature2020SuiteContext=v}]]);/*!
...
function _includesCompatibleContext({document}) {
  ...
  if(hasEd2018 && hasCred) {
    ...
    _3f9‍.g.console.warn('Warning: The ed25519-2018/v1 and credentials/v1 ' +
      'contexts are incompatible.');
    _3f9‍.g.console.warn('For VCs using Ed25519Signature2018 suite,' +
  ...
  if(hasEd2018 && hasSecV2) {
    // Warn if both are present
    _3f9‍.g.console.warn('Warning: The ed25519-2018/v1 and security/v2 ' +
      'contexts are incompatible.');
    _3f9‍.g.console.warn('For VCs using Ed25519Signature2018 suite,' +
