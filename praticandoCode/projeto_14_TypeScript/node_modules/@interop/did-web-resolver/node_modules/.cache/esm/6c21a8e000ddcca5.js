'use strict';let DidDocument,URL,didContext;_00d‍.x([["didFromUrl",()=>didFromUrl],["urlFromDid",()=>urlFromDid],["DidWebResolver",()=>DidWebResolver]]);_00d‍.w("did-io",[["DidDocument",["DidDocument"],function(v){DidDocument=v}]]);_00d‍.w("whatwg-url",[["URL",["URL"],function(v){URL=v}]]);_00d‍.w("did-context",[["default",["didContext"],function(v){didContext=v}]]);
