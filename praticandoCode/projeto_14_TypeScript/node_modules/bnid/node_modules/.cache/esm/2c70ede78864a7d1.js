let base58encoder,base58decoder,getRandomBytes,bytesToHex,bytesFromHex;_886‍.x([["IdGenerator",()=>IdGenerator],["IdEncoder",()=>IdEncoder],["IdDecoder",()=>IdDecoder],["generateId",()=>generateId],["decodeId",()=>decodeId],["minEncodedIdBytes",()=>minEncodedIdBytes],["maxEncodedIdBytes",()=>maxEncodedIdBytes],["generateSecretKeySeed",()=>generateSecretKeySeed],["decodeSecretKeySeed",()=>decodeSecretKeySeed]]);_886‍.w("base58-universal",[["encode",["base58encoder"],function(v){base58encoder=v}],["decode",["base58decoder"],function(v){base58decoder=v}]]);_886‍.w("./util.js",[["getRandomBytes",["getRandomBytes"],function(v){getRandomBytes=v}],["bytesToHex",["bytesToHex"],function(v){bytesToHex=v}],["bytesFromHex",["bytesFromHex"],function(v){bytesFromHex=v}]]);/*!
 ...
 */
       async function generateId(options) {
 ...
 */
       async function generateSecretKeySeed({
  bitLength = 32 * 8,
  encoding = 'base58',
  multibase = true,
  multihash = true
